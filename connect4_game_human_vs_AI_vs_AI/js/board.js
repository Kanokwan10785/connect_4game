...
Board.prototype.scorePosition = function(row, column, delta_y, delta_x) {
    ...
    for (var i = 0; i < 4; i++) {
        if (this.field[row][column] == 0) {
            ...
            this.game.winning_array_third.push([row, column]);
            third_points++; // Add for each player 3 chip
        }
    ...
    if (human_points == 4) {
        ...
        // Human won (-100000)
        return this.game.score;
    } else if (third_points == 4) {
        this.game.winning_array = this.game.winning_array_third;
        // Comp 3nd won (-100000)
        return this.game.score;
    } else {
